...
function mk_report
{
	...
	echo -e "\nNO,hostname,Architecture,OS Release,Kernel Release,CPU,Memory,FileSystem,Network,Process,,etc" > $REPORTFILE
	...
	do
		...
		tmp_str="$tmp_str,$cpu_use,$mem_use,$file_use,\"$network_unit\",$process_num,\"$info_etc\""
